 ...
 */
evm_val_t JsAppContext::Eval(const char * const jsFileFullPath, size_t fileNameLength, bool isAppEval) const
{
...
void JsAppContext::SetGlobalNamedProperty(bool isAppEval, evm_val_t viewModel) const
{
...
evm_val_t JsAppContext::Render(evm_val_t viewModel) const
{
    if (jerry_value_is_error(viewModel)) {
