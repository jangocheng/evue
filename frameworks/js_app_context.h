...
public:
     ...
     */
    evm_val_t Eval(const char * const jsFileFullPath, size_t fileNameLength, bool isAppEval) const;
    /**
     * @brief call FeatureAbility's render function
     *
     * @param: page instance, viewModel to call render on
     */
    evm_val_t Render(evm_val_t viewModel) const;
    /**
...
private:
    ...
    void SetGlobalNamedProperty(bool isAppEval, evm_val_t viewModel) const;
